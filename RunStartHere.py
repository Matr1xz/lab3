import os
# write for me code to get ./ location
import os
import os
...
try:
    ...
    if start_step == 1:
        ...
        os.system(r"python C:\Users\acer\Desktop\giautinamthanh\Video-Steganography\main-module\aviGUI.py")
    ...
    if start_step == 2:
        ...
        line_string = f'python3 ./wav-steg.py -h -d "{file_text}" -s "{file_audioOld}" -o output/steg_audio.wav -n {bits_int}'
