...
# hiding_data = False
# sound_path = r"C:\Users\acer\Desktop\giautinamthanh\Video-Steganography\output\output_video_audio.wav"
# sound_path_1 = r"C:\Users\acer\Desktop\giautinamthanh\Video-Steganography\output\steg_audio.wav"
# file_path = r"C:\Users\acer\Desktop\giautinamthanh\Video-Steganography\output\key.txt"
# output_path = r"C:\Users\acer\Desktop\giautinamthanh\Video-Steganography\output\steg_audio.wav"
# output_path_1 = r"C:\Users\acer\Desktop\giautinamthanh\Video-Steganography\output\decoded_audio.txt"
# num_lsb = 1
# recovering_data = True
# bytes_to_recover = 3

flag=  input("Do you want to hide data? (y/n): ")
if flag == 'y':
    hiding_data = True
    sound_path = input("Enter the path of the sound file: ")
    file_path = input("Enter the path of the data file: ")
    output_path = input("Enter the output path: ")
    num_lsb = int(input("Enter the number of LSBs to use: "))
    recovering_data= False
else:
    hiding_data = False
    sound_path = input("Enter the path of the sound file: ")
    output_path = input("Enter the output path: ")
    num_lsb = int(input("Enter the number of LSBs to use: "))
    bytes_to_recover = int(input("Enter the number of bytes to recover: "))
    recovering_data = True
try:
    if (hiding_data):
